...
def clean_data(data):
    ...
    '''
    image_links = data.iloc[:,[0,5,10]]            #Grab the columns where the urls for the image are stored
    link_dict = {}                                 #Create the cache
    for index, row in image_links.iterrows():      #Iterate over all the rows in the csv 
